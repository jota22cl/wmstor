...
namespace App\Filament\Resources\GuiaIngresoResource\Pages;

use App\Filament\Resources\GuiaIngresoResource;
...
class ViewGuiaIngreso extends ViewRecord
{
    protected static string $resource = GuiaIngresoResource::class;
    protected static string $view = 'filament.resources.guia-ingreso-resource.view-record';
    ...
    public function getTitle(): string
    {
        ...
        if ($contratoDetails) {
            ...
            return "Guía de Ingreso: [{$ccosto}] / [{$bodega}] / {$cliente}";
        }
