...
class CreateProducto extends CreateRecord
{
    ...
    {
        // Inserta un nuevo registro en la tabla ProductoPeriodos
...
//        Productoperiodo::create([
//            'producto_id' => $this->record->id, // ID del producto recién creado
//            //'periodo' => now()->format('Ym'), // Periodo actual en formato YYYYMM
//            'periodo' => auth()->user()->empresa->periodo,
////            'saldo_ini' => 0,                 // Valor inicial
////            'entradas' => 0,                  // Entradas iniciales
////            'salidas' => 0,                   // Salidas iniciales
