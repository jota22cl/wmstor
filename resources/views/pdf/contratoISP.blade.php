...
<p align='center'><u><b><font size="+1">CONTRATO DE DEPÓSITO <br>
    <p>**** para direrenciar este seria del tipo ISP ****</p>
    ...
    <p>En Santiago, a <b>{{ \Carbon\Carbon::parse($contrato->fecha_ini)->translatedFormat('d \d\e F \d\e Y') }}</b>, 
        ...
        <ol type="a">
            ...
            <ol type="*">
                <li>{{ $contrato->empresa->direccionContrato }} - {{ $contrato->empresa->comuna->nombre }}<br>
                    <b>Módulo {{ $el_modulo }} {{ $el_tipo }}</b></li>
            </ol>
        </ol>
        <p></p>
...
El cliente tendrá hasta 1m3 / Tonelada de retiro basura al mes.<p></p>
